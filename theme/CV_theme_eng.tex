...
\begin{document}
    ...
    \begin{twocolentry_project}{
        ...
        \begin{highlights}
            \item Developed an AI co-scientist agent integrating MCP and RAG architectures.
    ...
    \begin{onecolentry}
        ...
        \emph{KR Patent Application No.} 10-2025-0214325 (2025; international filings planned)
    \end{onecolentry}
